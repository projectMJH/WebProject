        ...
        <div class="row" style="margin-top: 20px">
            ...
            <div class="col-sm-4" id="detail" style="display:none">
                <table class="table">
                  ...
                  <td colspan="2">
                  <h3><span id="title" style="color:orange"></span></h3>
                  </td>
                  </tr>
                  <tr>
                  <td width=15% class="color:gray">음식종류</td>
                  <td width=55% id="type"></td>
                  </tr>
                  <tr>
                  <td width=15% class="color:gray">주소</td>
                  <td width=55% id="address"></td>
                  </tr>
                  <tr>
                  <td width=15% class="color:gray">전화</td>
                  <td width=55% id="phone"></td>
                  </tr>
                  <tr>
                  <td width=15% class="color:gray">가격대</td>
                  <td width=55% id="price"></td>
                  </tr>
                  <tr>
                  <td width=15% class="color:gray">주차</td>
                  <td width=55% id="parking"></td>
                  </tr>
                  <tr>
                  <td width=15% class="color:gray">영업시간</td>
                  <td width=55% id="time"></td>
                  </tr>
                  <tr>
                  <td width=15% class="color:gray">테마</td>
                  <td width=55% id="theme"></td>
                  </tr>
                </table>
                <table class="table">
                  <tr>
                  <td width=60% id="content"></td>
                  </tr>
                </table>
            </div>
        </div>    
