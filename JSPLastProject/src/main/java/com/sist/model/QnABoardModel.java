...
public class QnABoardModel {
	...
	@RequestMapping("qna/qna_insert_ok.do") // 요청
	...
	@RequestMapping("qna/qna_admin_list.do") // 요청
	...
	@RequestMapping("qna/qna_admin_insert.do") // 요청
	...
	@RequestMapping("qna/qna_admin_insert_ok.do") // 요청
	...
	@RequestMapping("qna/qna_delete.do") // 요청
	...
	@RequestMapping("qna/qna_admin_delete.do") // 요청
