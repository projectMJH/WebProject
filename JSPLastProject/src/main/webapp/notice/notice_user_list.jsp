            ...
            <div class="row" style="width:800px;">
                ...
                <table class="table">
                    <tr>
                        ...
                        <td class="text-right">
                            <a href="../admin/notice_user_list.do?page=${curpage>1?curpage-1:curpage }" class="btn btn-info btn-sm">이전</a>
                                ${curpage } page / ${totalpage } pages
                            <a href="../admin/notice_user_list.do?page=${curpage<totalpage?curpage+1:curpage }" class="btn btn-success btn-sm">다음</a>
                        </td>
                    </tr>
                </table>
            </div>
